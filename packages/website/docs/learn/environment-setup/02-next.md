...
Your app needs to include a CSS file that contains a `@strictcss` directive. This acts as a placeholder that is replaced by the generated CSS during builds.
